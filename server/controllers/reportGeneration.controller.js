...
exports.generateApprovalReport = async (req, res) => {
  try {
    ...
    await this.sendApprovalReportEmail(report);
...
exports.sendMonthlyReminders = async (req, res) => {
  try {
    ...
    for (const submission of remindersToSend) {
      ...
      // Send email reminder
      await this.sendEmailReminder(submission);
...
exports.sendApprovalReportEmail = async (report) => {
  // Email implementation would go here
  console.log(`Sending approval report email for report: ${report.reportId}`);
};

exports.sendEmailReminder = async (submission) => {
  // Email implementation would go here
  console.log(`Sending email reminder for submission: ${submission._id}`);
};
