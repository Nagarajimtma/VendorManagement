                    ...
                    >
                      <div className="h-24 bg-gradient-to-r from-purple-500 to-purple-700 flex items-center justify-center">
                        {consultant.avatar ? (
                          ...
                          <div className={`h-16 w-16 rounded-full flex items-center justify-center text-white text-xl font-bold ${getRandomColor(consultant.id)}`}>
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex justify-between items-center pt-3 border-t border-neutral-200 dark:border-neutral-700">
                          ...
                          <div className="flex space-x-1">
                            ...
                            <button className="p-1 text-red-600 hover:bg-red-100 rounded-full dark:hover:bg-red-900/30">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center">
                                {consultant.avatar ? (
                                  ...
                                  <div className={`h-10 w-10 rounded-full flex items-center justify-center text-white text-sm font-medium ${getRandomColor(consultant.id)}`}>
                                    {getInitials(consultant.name)}
                                  </div>
                                )}
                                <div className="ml-4">
