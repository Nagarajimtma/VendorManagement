...
const AdminLoginPage: React.FC = () => {
  ...
  return (
    <ModernLoginLayout
      ...
      backgroundImage="/images/3d-floor-admin.jpg"
      userType="admin"
      showDecorations={true}
    >
      {error && (
        <div className="mb-6 bg-red-50 border-l-4 border-red-500 p-4 dark:bg-red-900/30 dark:border-red-500" role="alert">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-800 dark:border-gray-700 dark:text-white"
