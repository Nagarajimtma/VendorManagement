...
const ModernLoginLayout: React.FC<ModernLoginLayoutProps> = ({
  ...
  title,
  subtitle,
  backgroundImage = '/images/3d-floor-background.jpg', // Default background
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
          ...
          <div>
            <div className="mb-12 flex flex-row items-center space-x-4">
              <img 
                src={logoUrl} 
                alt="IMTMA Logo" 
                className="h-20 w-auto filter drop-shadow-lg hover:scale-105 transition-transform duration-300"
            ...
            >
              ...
              {showDecorations && (
                ...
                >
                  ...
                  <div className="relative h-40 w-64 mx-auto">
                    <div className="absolute bottom-0 left-0 right-0 h-32 w-full bg-white/20 backdrop-blur-md rounded-lg shadow-xl transform skew-y-6"></div>
                    <div className="absolute bottom-2 left-2 right-2 h-32 w-full bg-white/30 backdrop-blur-md rounded-lg shadow-lg transform skew-y-3"></div>
                    <div className="absolute bottom-4 left-4 right-4 h-32 w-full bg-white/40 backdrop-blur-md rounded-lg shadow-md"></div>
                  </div>
                </motion.div>
              )}
              ...
              >
                <div className="h-1 w-12 bg-white rounded-full opacity-70"></div>
                <div className="h-1 w-12 bg-white rounded-full opacity-40"></div>
                <div className="h-1 w-12 bg-white rounded-full opacity-20"></div>
              </motion.div>
            </motion.div>
          </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12 lg:px-8 bg-white dark:bg-gray-900">
        <motion.div 
          key="right-panel"
          initial="hidden"
          animate="visible"
        ...
        >
          ...
          <motion.div 
            key="form-container"
            variants={itemVariants}
            className={`bg-white dark:bg-gray-800 py-8 px-6 shadow-xl rounded-xl border-t-4 ${colorScheme.accent}`}
          >
            {children}
          </motion.div>
          ...
          >
            ...
            <div className="mt-6 flex justify-center space-x-4">
              <Link to="/admin/login" className={`text-sm ${userType === 'admin' ? 'font-bold text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-400'}`}>
                Admin Login
              </Link>
              <Link to="/vendor/login" className={`text-sm ${userType === 'vendor' ? 'font-bold text-green-600 dark:text-green-400' : 'text-gray-600 dark:text-gray-400'}`}>
                Vendor Login
              </Link>
              <Link to="/consultant/login" className={`text-sm ${userType === 'consultant' ? 'font-bold text-purple-600 dark:text-purple-400' : 'text-gray-600 dark:text-gray-400'}`}>
                Consultant Login
              </Link>
            </div>
          </motion.div>
