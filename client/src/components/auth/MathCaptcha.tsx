  ...
  return (
    <div className="mt-4 mb-4">
      ...
      <div className="flex items-center space-x-2 mb-2">
        <div className="bg-gray-100 dark:bg-gray-800 p-2 rounded-md font-medium">
        ...
        <input
          ...
          className={`block w-24 px-3 py-2 border rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm ${
